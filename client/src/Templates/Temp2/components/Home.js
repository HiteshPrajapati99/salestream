...
import Sliderimage from "../images/slider-bg.jpg";
import arrival_bg from "../images/arrival-bg.png";
          ...
          <div className="row">
            <div className="col-md-4">
              <div className="box ">
                ...
                <div className="detail-box">
                  <h5 style={{ color: "white" }}>Fast Delivery</h5>
                  <p style={{ color: "white" }}>
                    {" "}
            ...
            <div className="col-md-4">
              <div className="box ">
                ...
                <div className="detail-box">
                  <h5 style={{ color: "white" }}>Free Shiping</h5>
                  <p style={{ color: "white" }}>
                    variations of passages of Lorem Ipsum available
                  </p>
                </div>
